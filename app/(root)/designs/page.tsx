...
const DesignsPage = () => {
  ...
  return (
    <div>
      <div className="flex flex-col items-center p-10 gap-5 font-notosanslao">
        <h1 className="text-heading4-bold">ມາສ້າງຄວາມເປັນເອກະລັກກັນ!</h1>
